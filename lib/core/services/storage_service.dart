...
class StorageService {
  ...
  Future<void> _migrate() async {
    final current = _prefs.getInt(StorageKeys.schemaVersion);
    if (current != null && current >= kSchemaVersion) return;
    // Migrações futuras: passos incrementais por versão (v1→v2, v2→v3…).
